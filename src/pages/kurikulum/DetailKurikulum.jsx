        ...
        {matkulList.length === 0 ? (
          ...
          <>
                ...
                <tbody className="divide-y">
                  {matkulList.map((mk, index) => (
                    <tr key={mk.id}>
                      ...
                      <td className="px-3 py-2">{mk.mataKuliah?.kode}</td>
                      <td className="px-3 py-2">{mk.mataKuliah?.nama}</td>
                      <td className="px-3 py-2 text-center">{mk.mataKuliah?.sks ?? "-"}</td>
                      <td className="px-3 py-2 text-center">{mk.semester ?? "-"}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="mt-4 flex justify-between">
              ...
              <button
                onClick={() => navigate(`/kurikulum/${id}/assignMatkul`)}
